  ...
  const fetchOrder = async () => {
    try {
      const response = await axios.get(
        `https://raftlab-i23i.onrender.com/orders/${id}`,
      );
          ...
          <div className="mt-14">
            <div className="flex items-center justify-between relative">
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <h4 className="font-semibold text-sm mt-1">Order Received</h4>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <h4 className="font-semibold text-sm mt-1">Preparing</h4>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <h4 className="font-semibold text-sm mt-1">Out For Delivery</h4>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <h4 className="font-semibold text-sm mt-1">Delivered</h4>
              </div>
            </div>
          </div>
        </div>
